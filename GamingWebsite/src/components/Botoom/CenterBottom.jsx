        ...
        <div className='w-[86%] mx-auto mt-24'>
            ...
            <div>
                ...
                <div className='flex gap-6 mt-5 flex-wrap xl:flex-nowrap justify-center'>
                    ...
                    <div className='image-container items-center text-center flex flex-col justify-center'>
                        <img className='w-[690px] h-[400px] rounded-xl' src={Bottom1} alt="img" />
                    ...
                    <div className='text-xl font-medium text-gray-500'>
                        ...
                        <div className='flex gap-7 flex-wrap md:flex-nowrap justify-center'>
                            <div className='w-[330px] image-container'>
                                <img className='w-full h-[210px] rounded-xl object-cover' src={Bottom1} alt="img" />
                                <h3 className='mt-2 text-center text-sm lg:text-xl'>G-Sync انویدیا چیست و چرا برای گیمرها اهمیت زیادی دارد ؟</h3>
                            </div>
                            <div className='w-[330px] image-container'>
                                <img className='w-full h-[210px] rounded-xl object-cover' src={Bottom2} alt="img" />
                        ...
                        <div className='flex gap-7 mt-10 flex-wrap md:flex-nowrap justify-center'>
                            <div className='w-[330px] image-container'>
                                <img className='w-full h-[210px] rounded-xl object-cover' src={Bottom3} alt="img" />
                                <h3 className='mt-2 text-center text-sm lg:text-xl'>چرا گیمرها باید اسپیکر را به هدفون ترجیح دهند؟</h3>
                            </div>
                            <div className='w-[330px] image-container'>
                                <img className='w-full h-[210px] rounded-xl object-cover' src={Bottom4} alt="img" />
            ...
            <div>
                ...
                <div className='flex flex-wrap 2xl:flex-nowrap gap-1 justify-center mt-8 mx-auto'>
                    <img className='w-[200px] rounded-md' src={BottomB1} alt="Bottom img" />
                    <img className='w-[200px] rounded-md' src={BottomB2} alt="Bottom img" />
                    <img className='w-[200px] rounded-md' src={BottomB3} alt="Bottom img" />
                    <img className='w-[200px] rounded-md' src={BottomB4} alt="Bottom img" />
                    <img className='w-[200px] rounded-md' src={BottomB5} alt="Bottom img" />
                    <img className='w-[200px] rounded-md' src={BottomB6} alt="Bottom img" />
                    <img className='w-[200px] rounded-md' src={BottomB7} alt="Bottom img" />
                </div>
