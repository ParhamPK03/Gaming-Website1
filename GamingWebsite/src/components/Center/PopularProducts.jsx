    ...
    return (
        <div className='h-[100vh] mt-16 lg:mt-20 xl:mt-52 w-[92%] m-auto' id='PopularProducts'>
            ...
            <div className='flex justify-between items-center mb-6'>
                <h2 className='lg:text-4xl md:text-2xl sm:text-xl text-lg text-red-600 font-normal cursor-default'>محصولات <span className='text-black'>محبوب</span></h2>
            ...
            <div className='flex items-end justify-between mt-10 gap-10'>
                ...
                <div className='relative w-[330px] h-[527px] hidden xl:flex'>
                    <img className='w-full h-full object-cover rounded-xl' src={HomePc} alt="Pc" />
