        ...
        <div className='bg-[#F0F2F8] w-[260px] sm:w-[410px] h-[300px] rounded-xl mt-5 items-center flex justify-center group relative mx-auto'>
            <div className='flex items-center'>
                ...
                <div className='pt-6 flex flex-col'>
                    ...
                    />
                    <Link to="/auction"><h5 className='absolute left-0 bottom-0 bg-white flex items-center text-[14px] font-medium p-1.5'>محصولات <IoMdArrowDropleft className='text-sm text-red-600' /></h5></Link>
                </div>
            </div>
        </div>
    );
...
const TopProductsList = () => {
    ...
    return (
        <div className='mt-28 w-[84%] mx-auto ' id='TopProduct'>
            {/* Title */}
            <div>
