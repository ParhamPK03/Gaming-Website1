...
import ProductSwiperSLiderimport from './ProductSwiperSLider';
  ...
  return (
    ...
    >
      ...
      <div className='flex justify-center sm:justify-around gap-0 sm:gap-20'>
        ...
        {/* Left */}
        <div className='-mt-16'>
          <img className='xl:w-[100%] lg:w-[450px] md:w-[350px] sm:w-[300px] w-[240px] hidden sm:flex' src={ControlImg} alt="Control Image" />
        </div>
      </div>
      ...
      <div>
        <div className='flex justify-center mt-32 relative'>
          <img className='w-0 sm:w-[1410px] h-[270px] rounded-xl hidden md:flex' src={Img2} alt="Background" />
          <img src={Home11} className='flex md:hidden rounded-xl' />
          ...
          <div className='absolute inset-0 flex justify-center gap-[120px] sm:gap-[160px] md:gap-[240px] lg:gap-[360px] xl:gap-[500px] 2xl:gap-[600px] items-center px-10'>
            ...
            {/* Logo on the left */}
            <div>
              <img src={HomeLogo} alt="logo" className='lg:w-[370px] sm:w-[260px] w-[200px] lg:h-[65px] pl-5' />
            </div>
          </div>
        </div>
